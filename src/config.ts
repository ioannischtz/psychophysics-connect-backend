...
export const corsMaxage = process.env.CORS_MAXAGE || DEFAULTS.CORS_MAXAGE;
...
export const jwtValiditySecs = process.env.JWT_VALIDITY_SEC ||
  DEFAULTS.JWT_VALIDITY_SEC;
...
export const limitConsecutiveAttempts =
  process.env.LIMIT_CONSECUTIVE_ATTEMPTS || DEFAULTS.LIMIT_CONSECUTIVE_ATTEMPTS;
export const limitAttemptsPerDay = process.env.LIMIT_ATTEMPTS_PER_DAY ||
  DEFAULTS.LIMIT_ATTEMPTS_PER_DAY;
